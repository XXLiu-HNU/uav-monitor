...
void FtxuiVis::DrawTUI()
{
    ftxui::Element Document = ftxui::vbox({
                                  ...
                                  ftxui::hbox({
                                      ftxui::hbox({
                                          create_mode_box(L"INIT", egoPlaner_mode_),
                                          ftxui::separator(),
                                      }),
                                      ftxui::hbox({
                                          create_mode_box(L"WAIT_TARGET", egoPlaner_mode_),
                                          ftxui::separator(),
                                      }),
                                      ftxui::hbox({
                                          create_mode_box(L"SEQUENTIAL_START", egoPlaner_mode_),
                                          ftxui::separator(),
                                      }),
                                      ftxui::hbox({
                                          create_mode_box(L"GEN_NEW_TRAJ ", egoPlaner_mode_),
                                          ftxui::separator(),
                                      }),
                                      ftxui::hbox({
                                          create_mode_box(L" REPLAN_TRAJ", egoPlaner_mode_),
                                          ftxui::separator(),
                                      }),
                                      ftxui::hbox({
                                          create_mode_box(L"EXEC_TRAJ", egoPlaner_mode_),
                                          ftxui::separator(),
                                      }),
                                      ftxui::hbox({
                                          create_mode_box(L"EMERGENCY_STOP", egoPlaner_mode_),
                                      }),
